...
#[
    ...
    Description: This is a POC for a shellcode injector written in nim that injects 
    user-provided shellcode into the memory space of the current process and executes it. 
...
when defined(windows):
    ...
    #msfvenom --arch x86 -p windows/exec CMD="C:\Windows\System32\Calc.exe" -f csharp
    ...
    when defined(i386):
        ...
        #msfvenom --arch x64 -p windows/x64/exec CMD="C:\Windows\System32\Calc.exe" -f csharp 
